...
Stay focussed on exloring the content and don't get overhelmed by a complex design.

<--->

### Light and mobile-friendly

The theme is powererd by less than 1 MB and looks impressive on mobile devices as well as on a regular Desktop.
...
Getting started in minutes. The theme is shipped with a default config and works out of the box.

<--->

### Handy shortcodes

We included some (hopefully) usefule custom shortcodes so you dont have to and can focus on writing amazing docs.

<--->

### Dark mode

Powerful dark mode that detects your system preferences or can be controlled by a toggle sitch.
